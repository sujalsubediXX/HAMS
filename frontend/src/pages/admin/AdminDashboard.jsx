...
const AdminDashboard = () => {
  ...
  const fetchGenderData = async () => {
    try {
      const res = await axios.get("/api/user/gender-stats");
  ...
  const fetchAppointmentStats = async () => {
    try {
      const res = await axios.get("/api/appointment/appointmentstats");
  ...
  const getTopSpecialties = async () => {
    try {
      const res = await axios.get("/api/appointment/getTopSpecialties");
  ...
  const fetchAgeStats = async () => {
    try {
      const res = await axios.get("/api/user/getAgeStats");
  ...
  const fetchdaydata = async () => {
    try {
      const res = await axios.get("/api/appointment/getchartdata");
      setdaydata(res.data);
    } catch (error) {
  ...
  const fetchDoctorData = async () => {
    try {
      const res = await axios.get("/api/appointment/chartDoctorAppointments");
