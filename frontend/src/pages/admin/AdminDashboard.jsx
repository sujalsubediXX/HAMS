...
const AdminDashboard = () => {
  ...
  const fetchGenderData = async () => {
    try {
      const res = await axios.get("http://localhost:3000/api/user/gender-stats");
  ...
  const fetchAppointmentStats = async () => {
    try {
      const res = await axios.get("http://localhost:3000/api/appointment/appointmentstats");
  ...
  const getTopSpecialties = async () => {
    try {
      const res = await axios.get("http://localhost:3000/api/appointment/getTopSpecialties");
  ...
  const fetchAgeStats = async () => {
    try {
      const res = await axios.get("http://localhost:3000/api/user/getAgeStats");
  ...
  const fetchdaydata = async () => {
    try {
      const res = await axios.get("http://localhost:3000/api/appointment/getchartdata");
      setdaydata(res.data);
    } catch (error) {
  ...
  const fetchDoctorData = async () => {
    try {
      const res = await axios.get("http://localhost:3000/api/appointment/chartDoctorAppointments");
