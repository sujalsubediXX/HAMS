  ...
  useEffect(() => {
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        ...
        (err) => {
          console.warn("Geolocation failed, trying IP method:", err.message);
          ...
          fetch("https://ipapi.co/json/")
            ...
            .catch(() => {
              setLocation({ lat: 27.6681, lng: 85.3206 }); // Default Kathmandu fallback
            });
        },
        {
      ...
      console.log("Geolocation not available, using IP method");
      fetch("https://ipapi.co/json/")
        .then((res) => res.json())
        .then((data) => {
          setLocation({
